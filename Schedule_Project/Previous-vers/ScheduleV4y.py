...
weekly_label = ttk.Label(money_frame, text="Weekly Hours")
weekly_label.configure(font=("Times New Roman", 15), foreground="Black")
weekly_label.grid(row=0, column=0, columnspan=3, padx=10, pady=10, sticky='w')


total_hours_label = ttk.Label(money_frame, text="Total Hours Worked: ")
total_hours_label.configure(font=("Times New Roman", 12), foreground="brown")
total_hours_label.grid(row=1, column=0,columnspan=3, padx=10, pady=10, sticky='w')

total_money_label = ttk.Label(money_frame, text="Total Expected Money: $")
total_money_label.configure(font=("Times New Roman", 12), foreground="brown")
total_money_label.grid(row=2, column=0,columnspan=3, padx=10, pady=10, sticky='w')

paid_label = ttk.Label(money_frame, text="Total Received Money: $")
paid_label.configure(font=("Times New Roman", 12), foreground="brown")
paid_label.grid(row=3, column=0,columnspan=3, padx=10, pady=10, sticky='w')

expected_label = ttk.Label(money_frame, text="Expected Payment: $")
expected_label.configure(font=("Times New Roman", 12), foreground="brown")
expected_label.grid(row=4, column=0,columnspan=3, padx=10, pady=10, sticky='w')

# Create labels for total hours and total money
monthly_label = ttk.Label(money_month_frame, text="Monthly Hours")
monthly_label.configure(font=("Times New Roman", 15), foreground="Black")
monthly_label.grid(row=0, column=0,columnspan=3, padx=10, pady=10, sticky='w')

total_hours_label_month = ttk.Label(money_month_frame, text="Total Hours Worked: ")
total_hours_label_month.configure(font=("Times New Roman", 12), foreground="brown")
total_hours_label_month.grid(row=1, column=0,columnspan=3, padx=10, pady=10, sticky='w')

total_money_label_month = ttk.Label(money_month_frame, text="Total Expected Money: $")
total_money_label_month.configure(font=("Times New Roman", 12), foreground="brown")
total_money_label_month.grid(row=2, column=0,columnspan=3, padx=10, pady=10, sticky='w')

paid_label_month = ttk.Label(money_month_frame, text="Total Received Money: $")
paid_label_month.configure(font=("Times New Roman", 12), foreground="brown")
paid_label_month.grid(row=3, column=0,columnspan=3, padx=10, pady=10, sticky='w')

expected_label_month = ttk.Label(money_month_frame, text="Expected Payment: $")
expected_label_month.configure(font=("Times New Roman", 12), foreground="brown")
...
def edit_class(id):
    ...
    if class_info:
        ...
        class_name_entry.grid(row=0, column=1, padx=10, pady=10, columnspan=2)
        ...
        date_entry.grid(row=1, column=1, padx=10, pady=10, columnspan=2)
        ...
        school_entry.grid(row=4, column=1, padx=10, pady=10, columnspan=2)
        ...
        rate_entry.grid(row=5, column=1, padx=10, pady=10, columnspan=2)
        
        paid_label = tk.Label(edit_window, text="Rate:")
        paid_label.grid(row=6, column=0, padx=10, pady=10)
        
        paid_var = ["yes","no"]
        paid_combobox = ttk.Combobox(edit_window,state="readonly")
        paid_combobox['values'] = paid_var
        if class_info[7] in paid_var:
            paid_combobox.current(paid_var.index(class_info[7]))
        paid_combobox.grid(row=6, column=1, padx=10, pady=10, columnspan=2)
        ...
        def update_class():
            ...
            cursor.execute(query, (class_name, date, start_time, end_time, school, rate, paid, id))
            connection.commit()
...
def calculate_totals():
    ...
    for class_data in classes2:
        ...
        total_money_month +=int(money)*hours_worked_month
