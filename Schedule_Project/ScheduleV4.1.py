...
def duplicate_classes():
    ...
    def get_class_info():
        ...
        if class_info:
            ...
            date_entry = DateEntry(
                duplicate_window, width=12, date_pattern="yyyy-mm-dd", font="Arial 12"
            )
            ...
            start_hour_spinbox = tk.Spinbox(
                duplicate_window, from_=1, to=24, width=4, wrap=True
            )
            ...
            start_minute_spinbox = tk.Spinbox(
                duplicate_window, from_=0, to=59, width=4, wrap=True
            )
            ...
            def duplicate_new_class():
                ...
                cursor.execute(
                    query, (class_name, date, start_time, end_time, school, rate)
                )
                connection.commit()
    ...
    get_info_button = tk.Button(
        duplicate_window, text="Get Info", command=get_class_info
    )
